...
from myproject.models import Token
...
app = Celery('tasks', broker='redis://redis:6379/0')    # todo


@app.task
def save_new_token(address: str, dex_name: str, network: str, created_at):
...
@app.task
def update_tokens_info(address: str, delay: int, dex_name: str, network: str) -> str | None:
